...
<body style="background-repeat: no-repeat; background-image: url('pics1.jpg'); background-size: cover;">
    <script>
    ...
    <form id="form2" runat="server">
        ...
        <div style="display: flex; justify-content: center;">
            <h1 style="text-align: center; border-radius: 20px; padding: 10px; background-color: white; width: 100%; margin: 2% 20% 0% 20%; color: rgb(135, 9, 238); -webkit-box-shadow: 10px 10px 5px 0px rgba(46,74,117,0.48); -moz-box-shadow: 10px 10px 5px 0px rgba(46,74,117,0.48); box-shadow: 10px 10px 5px 0px rgba(46,74,117,0.48);">Sign Up</h1>
        </div>
...
<label>Remember Me</label>--%>
        ...
        <br />
        <a href="ChatPage.aspx" runat="server" id="redirect" visible="false">Click here to redirect Chat page</a>
        </div>
