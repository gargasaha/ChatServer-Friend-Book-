                ...
                while (sqlDataReader.Read())
                {
                    ...
                    if (sqlDataReader[0].ToString().Equals(Session["Fid"].ToString()))
                    {
                        ...
                        if (sqlDataReader[4].ToString().Equals("1"))
                        {
                            ...
                            cell.Controls.Add(new System.Web.UI.WebControls.Label() { Text = time,CssClass= "chtlbl11" });
                            cell.CssClass = "lbl1";
                        }
                        else
                        {
                    ...
                    else
                    {
                        ...
                        if (sqlDataReader[4].ToString().Equals("1"))
                        {
                            ...
                            cell.Controls.Add(image);
                            cell.Controls.Add(new LiteralControl("<br/>"));
                            cell.Controls.Add(new System.Web.UI.WebControls.Label() { Text = time, CssClass = "chtlbl22" });
                            cell.CssClass = "lbl2";
                        }
                        else
                        {
